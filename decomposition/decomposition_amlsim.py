...
from functions.SQUIC_functions import squic_fit_sparse, check_symmetric_sparse
...
SAVE_FIG_DIR = 'decomposition/glasso_images/amlsim'
PLOT = True
SAVE_FIG = False
SEASONAL_PERIOD = 7
...
def main():
    ...
    # if PLOT:
    #     plot_timeseries(Y, "AMLSIM", dimension=dim, save_fig=SAVE_FIG_DIR, title="timeseries")
    ...
    # if PLOT:
    #     plot_timeseries(df_prepared, "AMLSIM", dimension=dim, save_fig=SAVE_FIG_DIR, title="timeseries_norm")
    ...
    if dim == '100':
        ...
        lambdas = [0.4, 0.2, 0.1, 0.07, 0.05]
    elif dim == '1K':
        lambdas = [0.999, 0.95, 0.7, 0.5]
    elif dim == '10K':
        # lambdas = [0.9999995]
        ...
        # lambdas = [0.995]
        lambdas = [0.99995, 0.9999, 0.9995, 0.999]
